"""Pipeline-плагин: индексация явного списка страниц Confluence.

ConfigSection [indexer.pipelines.confluence_pages] + PIPELINE через factory.
"""
...
from boba.ext.confluence_indexing.pipeline_factory import (
    ConfluenceIndexingPipelineFactory,
)
from boba.ext.confluence_indexing.request_sources import (
...
PIPELINE = ConfluenceIndexingPipelineFactory.make(
    ConfluencePagesPipelineConfigSection,
    lambda cfg: ConfluencePagesRequestSource(
