...
Собирает цепочку (образ workspace или обычный bwrap), считает лимиты,
уводит трассировку лаунчера в лог и объясняет упёршиеся лимиты словами.
"""
...
from boba.toolkit.process.runner import RunResult, run_subprocess
from boba.toolkit.sandbox.argv import build_bwrap_argv
from boba.toolkit.sandbox.call_context import ToolCallContext
from boba.toolkit.sandbox.cgroup import CgroupManager, GroupLimits
...
from boba.toolkit.workspace import build_chain_argv, require_fuse
...
__all__ = ["SandboxOutcome", "SandboxRunner"]
