...
Конкретные типы соединений живут в пакетах-владельцах и попадают сюда через
ConnectionBase; ядро конкретных типов не знает.
...
class StoredConnection(BaseModel):
    """Строка connections с расшифрованным соединением."""
