"""Kerberos-секции профилей соединений: keytab, пароль, делегирование, билет вызова
и граница дампа секции в песочницу. Пути кэшей и krb5.conf сюда не входят.
...
from boba.kerberos.errors import KerberosError
