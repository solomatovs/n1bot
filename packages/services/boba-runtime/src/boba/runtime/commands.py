"""Исполнение команд шины держателем: StopRequested останавливает запуск или ход
этого процесса.
...
class CommandRunner:
    """Подписчик команд процесса: берёт команду области, которую ведёт этот процесс,
    и исполняет её через RunRegistry.
    """
