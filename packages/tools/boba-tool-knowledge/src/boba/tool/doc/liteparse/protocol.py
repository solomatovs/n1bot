"""Контракт liteparse-payload'а: общие настройки парсера и разбор байт.

Инструменты, которые скачивают документ по сети, шлют его содержимое прямо
в запросе (base64) — файловой системы, общей с песочницей, у них нет.
"""
