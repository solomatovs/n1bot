...
Pure-data integration: реальный `ConfluenceJsonDecoder`, синтетические
REST-payload'ы. Без mock'ов (Mock'ов тут никогда и не было — Decoder
тестируется напрямую на синтетических `RawDocument`).
"""
