...
class ConfluenceOps:
    ...
    def page(cls, request: dict[str, Any]) -> dict[str, Any]:
        ...
        from pages import PageOps  # noqa: PLC0415 — markdown нужен не всегда
    ...
    def hit(cls, hit: dict[str, Any], base: str, snippet_chars: int) -> dict[str, Any]:
        from pages import PageOps  # noqa: PLC0415 — excerpt разбирается bs4
    ...
    def attachment(cls, request: dict[str, Any]) -> dict[str, Any]:
        ...
        from documents import DocumentOps  # noqa: PLC0415 — парсер нужен только тут
