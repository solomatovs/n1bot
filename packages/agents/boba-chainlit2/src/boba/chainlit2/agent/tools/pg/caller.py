...
from boba.chainlit2.agent.tools.pg.protocol import (
    PgCopyAnswer,
    PgCopyRequest,
    PgQueryAnswer,
    PgQueryRequest,
...
class PgCaller:
    ...
    def query(
        ...
        *,
        ...
        return self._caller.call_json(self._entry, request, PgQueryAnswer)
    ...
    def copy(
        ...
        *,
        ...
        return self._caller.call_json(self._entry, request, PgCopyAnswer)
