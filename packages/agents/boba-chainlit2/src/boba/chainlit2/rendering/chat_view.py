"""Лента чата: вопрос, сворачиваемый процесс ответа, итоговый ответ.

Единственное место, знающее раскладку интерфейса и отрисовку результатов
инструментов. Живой ответ уходит в сокет (LiveSink), история треда
собирается теми же вызовами в список StepDict (RecordingSink).
"""
