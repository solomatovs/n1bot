...
// boba: подписка на messagesState перерисовывала кнопки всех сообщений на каждый
// токен; нужен только firstInteraction, и компонент мемоизирован по пропсам
const MessageButtons = memo(({ message, actions, run, contentRef }: Props) => {
