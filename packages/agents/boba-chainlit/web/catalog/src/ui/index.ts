/** Виджеты страницы каталога: каждый элемент интерфейса существует ровно
 * здесь, страницы и доменные компоненты собираются из них. */
...
export { Detail, Form, Grow, Index, IndexHead, Page, PageBody, PageNotices, Pane, Row, Scene, Stack } from "./Layout";
export { List, ListAside, ListName, ListNote, ListRow, type ListKind } from "./List";
