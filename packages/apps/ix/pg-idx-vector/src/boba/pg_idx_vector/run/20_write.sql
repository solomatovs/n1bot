/*
pg-idx-vector, шаг 2: записать все чанки одного аспекта одним statement'ом в таблицу
{table}, имя которой подставляет AspectEmbedding. Чанки
...
where
    ...
    or {table}.content is distinct from excluded.content;
