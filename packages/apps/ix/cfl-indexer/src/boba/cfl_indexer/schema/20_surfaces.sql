...
хэши; ни тела страницы, ни файла здесь нет. content_hash это sha256 сырого контента
сущности, как его отдал сервер (ответ с телом страницы или спейса, байты файла, html
комментария), indexer_hash это md5 параметров преобразования и модели:
