...
```
.venv/bin/boba-pg-idx-trgm --dsn "host=<хост ix> port=5432 dbname=<база ix> user=<роль> password=<пароль>"
```
...
```
.venv/bin/boba-pg-idx-trgm --dsn "host=... dbname=... user=... password=..." [--batch 500]
```
