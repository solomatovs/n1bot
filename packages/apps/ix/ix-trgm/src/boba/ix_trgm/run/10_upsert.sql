/*
ix-trgm, шаг 1: вставить недостающие строки и обновить те, у которых content
...
todo as (
    ...
    where
        ix_trgm.content is distinct from excluded.content
    returning 1
)
select
    'upsert' as op,
