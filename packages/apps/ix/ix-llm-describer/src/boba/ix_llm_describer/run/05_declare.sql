/*
ix-llm-describer, шаг 0: объявить аспект llm_description для каждой поверхности, у которой
...
select
    sa.surface,
    'llm_description',
    'select node_id, content from {{schema}}.llm_description where surface = '
