/*
ora-meta-scraper, схема, шаг 0a: значения aspect_e, которые использует скрапер. Имена
те же, что у pg-meta-scraper и ch-meta-scraper: индексаторы подписаны на классы, а не
на владельцев.
*/
