...
Библиотечная часть ix-vector. Воркер pg зовёт её в своём цикле для
ix_emb_e5_1024, индексаторы других происхождений — в своём, со своей
...
class WriteFile(StrEnum):
    """Файл записи набора чанков; лежит в run/ пакета ix-vector."""
