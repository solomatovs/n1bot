-- psql: psql (PostgreSQL) 19beta3
-- server: PostgreSQL 19beta3 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 8.5.0, 64-bit
...
-- ===== \drds =====
/* Get per-database and per-role settings */
...
ORDER BY 1;
/* Get publications that publish this schema */
SELECT pubname 
...
SELECT n.nspname as "Schema",
  c.relname as "Name",
  CASE c.relkind WHEN 'r' THEN 'table' WHEN 'v' THEN 'view' WHEN 'm' THEN 'materialized view' WHEN 'i' THEN 'index' WHEN 'S' THEN 'sequence' WHEN 't' THEN 'TOAST table' WHEN 'f' THEN 'foreign table' WHEN 'p' THEN 'partitioned table' WHEN 'I' THEN 'partitioned index' WHEN 'g' THEN 'property graph' END as "Type",
  pg_catalog.pg_get_userbyid(c.relowner) as "Owner"
FROM pg_catalog.pg_class c
     LEFT JOIN pg_catalog.pg_namespace n ON n.oid = c.relnamespace
     LEFT JOIN pg_catalog.pg_am am ON am.oid = c.relam
WHERE c.relkind IN ('r','p','v','m','S','f','g','')
...
FROM pg_catalog.pg_class c
     LEFT JOIN pg_catalog.pg_namespace n ON n.oid = c.relnamespace
     LEFT JOIN pg_catalog.pg_am am ON am.oid = c.relam
WHERE c.relkind IN ('r','p','t','v','m','S','s','f','g','')
  AND pg_catalog.pg_table_is_visible(c.oid)
ORDER BY 1,2;
...
-- ===== \d app.* =====
/* Get matching relations to describe */
SELECT c.oid,
  n.nspname,
  c.relname
FROM pg_catalog.pg_class c
...
WHERE n.nspname OPERATOR(pg_catalog.~) '^(app)$' COLLATE pg_catalog.default
ORDER BY 2, 3;
/* Get general information about one relation */
...
WHERE c.oid = '16422';
/* Get per-column information for one relation */
SELECT a.attname,
...
ORDER BY conname;
/* Get row-level policies for this table */
...
/* Get extended statistics for this table */
...
/* Get publications that publish this table */
SELECT pubname
     , NULL
     , NULL
FROM pg_catalog.pg_publication p
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16422')
     ...
     (pr.prrelid = '16422' OR pr.prrelid = pg_catalog.pg_partition_root('16422')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16422' OR pr.prrelid = pg_catalog.pg_partition_root('16422'))
AND pr.prexcept
ORDER BY 1;
/* Get triggers for this relation */
...
/* Get publications containing this sequence */
SELECT pubname FROM pg_catalog.pg_publication p
WHERE p.puballsequences
 AND pg_catalog.pg_relation_is_publishable('16421')
ORDER BY 1;
/* Get general information about one relation */
SELECT c.relchecks, c.relkind, c.relhasindex, c.relhasrules, c.relhastriggers, c.relrowsecurity, c.relforcerowsecurity, false AS relhasoids, c.relispartition, '', c.reltablespace, CASE WHEN c.reloftype = 0 THEN '' ELSE c.reloftype::pg_catalog.regtype::pg_catalog.text END, c.relpersistence, c.relreplident, am.amname
FROM pg_catalog.pg_class c
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16463')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16463' OR pr.prrelid = pg_catalog.pg_partition_root('16463')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16463' OR pr.prrelid = pg_catalog.pg_partition_root('16463'))
AND pr.prexcept
ORDER BY 1;
/* Get foreign server for this table */
SELECT s.srvname,
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16621')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16621' OR pr.prrelid = pg_catalog.pg_partition_root('16621')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16621' OR pr.prrelid = pg_catalog.pg_partition_root('16621'))
AND pr.prexcept
ORDER BY 1;
/* Get inheritance parent tables */
SELECT c.oid::pg_catalog.regclass
...
SELECT pubname FROM pg_catalog.pg_publication p
WHERE p.puballsequences
 AND pg_catalog.pg_relation_is_publishable('16620')
ORDER BY 1;
/* Get general information about one relation */
SELECT c.relchecks, c.relkind, c.relhasindex, c.relhasrules, c.relhastriggers, c.relrowsecurity, c.relforcerowsecurity, false AS relhasoids, c.relispartition, '', c.reltablespace, CASE WHEN c.reloftype = 0 THEN '' ELSE c.reloftype::pg_catalog.regtype::pg_catalog.text END, c.relpersistence, c.relreplident, am.amname
FROM pg_catalog.pg_class c
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16436')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16436' OR pr.prrelid = pg_catalog.pg_partition_root('16436')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16436' OR pr.prrelid = pg_catalog.pg_partition_root('16436'))
AND pr.prexcept
ORDER BY 1;
/* Get inheritance parent tables */
SELECT c.oid::pg_catalog.regclass
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16405')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16405' OR pr.prrelid = pg_catalog.pg_partition_root('16405')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16405' OR pr.prrelid = pg_catalog.pg_partition_root('16405'))
AND pr.prexcept
ORDER BY 1;
/* Get triggers for this relation */
SELECT t.tgname, pg_catalog.pg_get_triggerdef(t.oid, true), t.tgenabled, t.tgisinternal,
...
SELECT pubname FROM pg_catalog.pg_publication p
WHERE p.puballsequences
 AND pg_catalog.pg_relation_is_publishable('16404')
ORDER BY 1;
/* Get general information about one relation */
SELECT c.relchecks, c.relkind, c.relhasindex, c.relhasrules, c.relhastriggers, c.relrowsecurity, c.relforcerowsecurity, false AS relhasoids, c.relispartition, '', c.reltablespace, CASE WHEN c.reloftype = 0 THEN '' ELSE c.reloftype::pg_catalog.regtype::pg_catalog.text END, c.relpersistence, c.relreplident, am.amname
FROM pg_catalog.pg_class c
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16595')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16595' OR pr.prrelid = pg_catalog.pg_partition_root('16595')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16595' OR pr.prrelid = pg_catalog.pg_partition_root('16595'))
AND pr.prexcept
ORDER BY 1;
/* Get inheritance parent tables */
SELECT c.oid::pg_catalog.regclass
...
ORDER BY a.attnum;
/* Get partitioning information for this table */
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16610')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16610' OR pr.prrelid = pg_catalog.pg_partition_root('16610')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16610' OR pr.prrelid = pg_catalog.pg_partition_root('16610'))
AND pr.prexcept
ORDER BY 1;
/* Get inheritance parent tables */
SELECT c.oid::pg_catalog.regclass
...
ORDER BY a.attnum;
/* Get partitioning information for this partition */
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('16613')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '16613' OR pr.prrelid = pg_catalog.pg_partition_root('16613')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '16613' OR pr.prrelid = pg_catalog.pg_partition_root('16613'))
AND pr.prexcept
ORDER BY 1;
/* Get inheritance parent tables */
SELECT c.oid::pg_catalog.regclass
...
SELECT pubname FROM pg_catalog.pg_publication p
WHERE p.puballsequences
 AND pg_catalog.pg_relation_is_publishable('16403')
ORDER BY 1;
...
AND pr.prexcept
ORDER BY 1;
/* Get not-null constraints for this table */
...
WHERE p.puballtables AND pg_catalog.pg_relation_is_publishable('1259')
     ...
     FROM pg_catalog.pg_publication_rel pr
     WHERE pr.prpubid = p.oid AND
     (pr.prrelid = '1259' OR pr.prrelid = pg_catalog.pg_partition_root('1259')))
ORDER BY 1;
/* Get publications that exclude this table */
SELECT pubname
FROM pg_catalog.pg_publication p
JOIN pg_catalog.pg_publication_rel pr ON p.oid = pr.prpubid
WHERE (pr.prrelid = '1259' OR pr.prrelid = pg_catalog.pg_partition_root('1259'))
AND pr.prexcept
ORDER BY 1;
/* Get inheritance parent tables */
SELECT c.oid::pg_catalog.regclass
...
-- ===== \dAf =====
/* Get matching operator families */
SELECT
  am.amname AS "AM",
  CASE
...
-- ===== \dAo =====
/* Get operators of matching operator families */
SELECT
  am.amname AS "AM",
  CASE
    WHEN pg_catalog.pg_opfamily_is_visible(of.oid)
...
-- ===== \dAp =====
/* Get support functions of matching operator families */
SELECT
  am.amname AS "AM",
  CASE
    WHEN pg_catalog.pg_opfamily_is_visible(of.oid)
...
-- ===== \dconfig =====
/* Get matching configuration parameters */
...
-- ===== \dew =====
/* Get matching foreign-data wrappers */
...
-- ===== \dF =====
/* Get matching text search configurations */
SELECT
   n.nspname as "Schema",
   c.cfgname as "Name",
...
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13158' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13160' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13162' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13164' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13166' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13168' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13170' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13172' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13174' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13176' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13178' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13180' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13182' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
...
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13184' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13186' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13188' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13190' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;
/* Get text search configuration details */
SELECT
  ...
  '{}') AS "Dictionaries"
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m
WHERE c.oid = '13192' AND m.mapcfg = c.oid
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser
ORDER BY 1;

-- ===== \dFd =====
/* Get matching text search dictionaries */
SELECT
  n.nspname as "Schema",
  d.dictname as "Name",
...
WHERE pg_catalog.pg_ts_parser_is_visible(p.oid)
ORDER BY 1, 2;
/* Get text search parser details */
...
SELECT 'Get token types',
 ...
 FROM pg_catalog.pg_ts_parser p
 WHERE p.oid = '3722';
/* Get text search parser token types */
...
-- ===== \dFt =====
/* Get matching text search templates */
SELECT
  n.nspname AS "Schema",
  t.tmplname AS "Name",
...
-- ===== \dL =====
/* Get matching procedural languages */
...
-- ===== \dp =====
/* Get access privileges of matching relations */
SELECT n.nspname as "Schema",
  c.relname as "Name",
  CASE c.relkind WHEN 'r' THEN 'table' WHEN 'v' THEN 'view' WHEN 'm' THEN 'materialized view' WHEN 'S' THEN 'sequence' WHEN 'f' THEN 'foreign table' WHEN 'g' THEN 'property graph' WHEN 'p' THEN 'partitioned table' END as "Type",
...
FROM pg_catalog.pg_class c
     LEFT JOIN pg_catalog.pg_namespace n ON n.oid = c.relnamespace
WHERE c.relkind IN ('r','v','m','S','f','g','p')
      AND n.nspname <> 'pg_catalog'
      AND n.nspname <> 'information_schema'
  AND pg_catalog.pg_table_is_visible(c.oid)
ORDER BY 1, 2;
...
-- ===== \dP =====
/* Get matching partitioned relations */
SELECT n.nspname as "Schema",
  c.relname as "Name",
  pg_catalog.pg_get_userbyid(c.relowner) as "Owner",
...
-- ===== \dRp+ =====
/* Get details about matching publications */
SELECT oid, pubname,
  pg_catalog.pg_get_userbyid(pubowner) AS owner,
  puballtables, puballsequences, pubinsert, pubupdate, pubdelete, pubtruncate, (CASE pubgencols
    WHEN 'n' THEN 'none'
    WHEN 's' THEN 'stored'
   END) AS "Generated columns"
, pubviaroot, pg_catalog.obj_description(oid, 'pg_publication')
FROM pg_catalog.pg_publication
ORDER BY 2;
/* Get tables published by this publication */
SELECT n.nspname, c.relname, pg_catalog.pg_get_expr(pr.prqual, c.oid), (CASE WHEN pr.prattrs IS NOT NULL THEN
...
WHERE c.relnamespace = n.oid
  ...
  AND NOT pr.prexcept
ORDER BY 1,2;
/* Get schemas published by this publication */
SELECT n.nspname
FROM pg_catalog.pg_namespace n
...
, (select srvname from pg_catalog.pg_foreign_server where oid=subserver) AS "Server"
...
, subwalrcvtimeout AS "Receiver timeout"
...
-- ===== \dx =====
/* Get matching installed extensions */
...
ORDER BY 1;
/* Get installed extension's contents */
...
SELECT pg_catalog.pg_describe_object(classid, objid, 0) AS "Object description"
FROM pg_catalog.pg_depend
WHERE refclassid = 'pg_catalog.pg_extension'::pg_catalog.regclass AND refobjid = '13592' AND deptype = 'e'
ORDER BY 1;
...
-- ===== \dX =====
/* Get matching extended statistics */
SELECT 
...
/* Get view's definition and details */
