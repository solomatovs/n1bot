...
-- server: PostgreSQL 9.4.26 on x86_64-unknown-linux-gnu, compiled by gcc (GCC) 8.5.0, 64-bit
...
WHERE c.oid = '11563' AND m.mapcfg = c.oid 
...
SELECT 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11565' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11567' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11569' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11571' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11573' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11575' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11577' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11579' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11581' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11583' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11585' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
...
SELECT 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11587' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11589' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
SELECT 
  ( SELECT t.alias FROM 
  ...
  '{}') AS "Dictionaries" 
FROM pg_catalog.pg_ts_config AS c, pg_catalog.pg_ts_config_map AS m 
WHERE c.oid = '11591' AND m.mapcfg = c.oid 
GROUP BY m.mapcfg, m.maptokentype, c.cfgparser 
ORDER BY 1;
...
SELECT pg_catalog.pg_describe_object(classid, objid, 0) AS "Object Description"
FROM pg_catalog.pg_depend
WHERE refclassid = 'pg_catalog.pg_extension'::pg_catalog.regclass AND refobjid = '11862' AND deptype = 'e'
ORDER BY 1;
