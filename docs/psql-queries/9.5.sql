-- psql: psql (PostgreSQL) 9.5.25
-- server: PostgreSQL 9.5.25 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 8.5.0, 64-bit
...
WHERE c.oid = '12059' AND m.mapcfg = c.oid 
...
SELECT pg_catalog.pg_describe_object(classid, objid, 0) AS "Object Description"
FROM pg_catalog.pg_depend
WHERE refclassid = 'pg_catalog.pg_extension'::pg_catalog.regclass AND refobjid = '12362' AND deptype = 'e'
ORDER BY 1;
