...
from raw_depend d
join stage_node i_n on i_n.kind = 'rel' and i_n.surface = 'pg_index' and i_n.oid = d.objid
...
join stage_node v_n on v_n.kind = 'rel' and v_n.surface = 'pg_view' and v_n.oid = r.ev_class
...
from raw_depend d
join stage_node s_n on s_n.kind = 'rel' and s_n.surface = 'pg_sequence' and s_n.oid = d.objid
join stage_node c_n on c_n.kind = 'col' and c_n.oid = d.refobjid and c_n.subid = d.refobjsubid
