...
``python -m boba_cli_vector_index``.
"""
...
from boba_cli_vector_index._chunking import (
    DEFAULT_CHUNK_OVERLAP,
    DEFAULT_CHUNK_SIZE,
)
from boba_cli_vector_index._config import CliConfig, CliConfigError
from boba_cli_vector_index._indexer import (
    IndexOptions,
    index_paths,
)
from boba_cli_vector_index._store import VectorStore

logger = logging.getLogger("boba_cli_vector_index")
