...
create unique index if not exists idx_users_identifier_lower on users (lower(identifier));

-- таблицы шины из времён до схемы live: мусор прошлых прогонов
drop table if exists live_instances, live_events, live_commands, live_locks, live_payloads cascade;
